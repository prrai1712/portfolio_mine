...
const InfrastructureGlobe = dynamic(
  () =>
    import('@/components/three/InfrastructureGlobe').then((m) => ({
      default: m.InfrastructureGlobe,
    })),
  {
    ssr: false,
    loading: () => (
      <div className="h-full w-full min-h-[320px] rounded-2xl bg-indigo-500/5 animate-pulse" />
    ),
  }
)
